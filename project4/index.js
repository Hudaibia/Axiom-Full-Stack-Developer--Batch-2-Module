...
// Function to fetch exchange rates from API nad update DOM
function calculate() {
...
// Event Listeners
// 1. Listen for change base currency select box
...
// 3. Listen for change target currency select box
targetCurrency.addEventListener('change', calculate);

// 4.Listen for input in base amount input field
