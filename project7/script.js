...
// Array to hold the letters from correct guesse

// const correctLetters = ['a','e','i','o','u','b','c','d','f','g','h','i','j','k','l','m','n','p','q','r','s','t','v','w','x','y','z'];
const correctLetters = [];

// Array to hld the letters from incorrect guesse 
...
function renderWord(){
  ...
  // in the correctLetters array
    ...
    // Remove the new line charachter from the word
...
// Display the hangman part for everytime user inputs an incorrect letter
  ...
  hangmanParts.forEach((part, index)=> {
    ...
    // check if the index of the hangman part is less than the number of incorrect letters
