...
function addUserData(user) {
    // Push user object to the userArr 
    userArray.push(user);
    // Update the DOM with new Data in user Array
    updateDOM();
    
};

// Function to update the DOM with new user data from user Array
...
// Function to sum all the users are sorted 
function calculateNetWealth(){
      ...
      // Append the new total WealthDiv into the DOM
...
// Listen for click on the Double Wealth Button
